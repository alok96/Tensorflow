...
public class ImageIndentification  implements Interactor{
    private static final String TAG = "ImageIdentification";
    ...
    public static Interactor create(
            ...
            String outputName)
            throws IOException {
        ImageIndentification c = new ImageIndentification();
